# python -u "c:\Users\fathi\.gemini\antigravity\scratch\Internship\selenium_ollama_scraper\main.py" --url "https://ollama.com/" --headless --depth 5 --model "codellama:7b-instruct"
import argparse
import json
import logging
import os
...
def main():
    ...
    parser.add_argument("--model", type=str, default="codellama:7b-instruct", help="Ollama model to use ")
